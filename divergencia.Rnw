...
La variable dependiente que hemos considerado en el trabajo se encu

Y será una variable binaria que toma el valor de 1 para los individuos etiquetados como Activa y 0 para los No activa.
